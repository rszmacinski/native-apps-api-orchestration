...
trait OrchestrationService {
  ...
  def startup(nino: uk.gov.hmrc.domain.Nino, journeyId: Option[String]) (implicit hc: HeaderCarrier, ex: ExecutionContext): Future[Boolean]
...
// TODO...ALL CALLS MUST BE EXECUTED IN PARALLEL!
